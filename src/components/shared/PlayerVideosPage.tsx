...
export default function PlayerVideosPage({ accountType }: PlayerVideosPageProps) {
  ...
  const copy = useMemo<PlayerVideosCopy>(() => ({
    compactMillion: t('playerVideos.compactMillion'),
    compactThousand: t('playerVideos.compactThousand'),
    externalLink: t('playerVideos.externalLink'),
    errorMessages: {
      network: t('playerVideos.errorMessages.network'),
      format: t('playerVideos.errorMessages.format'),
      timeout: t('playerVideos.errorMessages.timeout'),
      unknown: t('playerVideos.errorMessages.unknown'),
    },
    externalNotice: t('playerVideos.externalNotice'),
    slowConnectionHint: t('playerVideos.slowConnectionHint'),
    openBrowserHint: t('playerVideos.openBrowserHint'),
    unavailableHint: t('playerVideos.unavailableHint'),
    retry: t('playerVideos.retry'),
    youtube: t('playerVideos.youtube'),
    openInBrowser: t('playerVideos.openInBrowser'),
    followedTitle: t('playerVideos.followedTitle'),
    followTitle: t('playerVideos.followTitle'),
    message: t('playerVideos.message'),
    noVideosTitle: t('playerVideos.noVideosTitle'),
    noVideosDesc: t('playerVideos.noVideosDesc'),
    back: t('playerVideos.back'),
    defaultPlayer: t('playerVideos.defaultPlayer'),
    defaultUser: t('playerVideos.defaultUser'),
    loadingVideos: t('playerVideos.loadingVideos'),
    forYou: t('playerVideos.forYou'),
    following: t('playerVideos.following'),
    filtersTitle: t('playerVideos.filtersTitle'),
    filtersCount: t('playerVideos.filtersCount'),
    clearAll: t('playerVideos.clearAll'),
    searchPlaceholder: t('playerVideos.searchPlaceholder'),
    position: t('playerVideos.position'),
    allPositions: t('playerVideos.allPositions'),
    country: t('playerVideos.country'),
    allCountries: t('playerVideos.allCountries'),
    age: t('playerVideos.age'),
    from: t('playerVideos.from'),
    to: t('playerVideos.to'),
    phone: t('playerVideos.phone'),
    phonePlaceholder: t('playerVideos.phonePlaceholder'),
    resultCount: t('playerVideos.resultCount'),
    showResults: t('playerVideos.showResults'),
    swipeUp: t('playerVideos.swipeUp'),
