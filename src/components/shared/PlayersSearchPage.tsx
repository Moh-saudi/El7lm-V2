...
export default function PlayersSearchPage({ accountType }: PlayersSearchPageProps) {
  ...
  const copy = useMemo<PlayersSearchCopy>(() => ({
    show: t('playersSearch.show'),
    playersPerPage: t('playersSearch.playersPerPage'),
    range: t('playersSearch.range'),
    previous: t('playersSearch.previous'),
    next: t('playersSearch.next'),
    loading: t('playersSearch.loading'),
    title: t('playersSearch.title'),
    subtitle: t('playersSearch.subtitle'),
    searchPlaceholder: t('playersSearch.searchPlaceholder'),
    filters: t('playersSearch.filters'),
    reset: t('playersSearch.reset'),
    refresh: t('playersSearch.refresh'),
    basicInfo: t('playersSearch.basicInfo'),
    position: t('playersSearch.position'),
    choosePosition: t('playersSearch.choosePosition'),
    allPositions: t('playersSearch.allPositions'),
    country: t('playersSearch.country'),
    chooseCountry: t('playersSearch.chooseCountry'),
    allCountries: t('playersSearch.allCountries'),
    nationality: t('playersSearch.nationality'),
    chooseNationality: t('playersSearch.chooseNationality'),
    allNationalities: t('playersSearch.allNationalities'),
    ageAndBirth: t('playersSearch.ageAndBirth'),
    minAge: t('playersSearch.minAge'),
    maxAge: t('playersSearch.maxAge'),
    example18: t('playersSearch.example18'),
    example30: t('playersSearch.example30'),
    birthYear: t('playersSearch.birthYear'),
    chooseBirthYear: t('playersSearch.chooseBirthYear'),
    allYears: t('playersSearch.allYears'),
    additionalInfo: t('playersSearch.additionalInfo'),
    skillLevel: t('playersSearch.skillLevel'),
    chooseSkillLevel: t('playersSearch.chooseSkillLevel'),
    allLevels: t('playersSearch.allLevels'),
    phone: t('playersSearch.phone'),
    phonePlaceholder: t('playersSearch.phonePlaceholder'),
    importantNote: t('playersSearch.importantNote'),
    filtersNoteStart: t('playersSearch.filtersNoteStart'),
    filtersNoteStrong: t('playersSearch.filtersNoteStrong'),
    filtersNoteEnd: t('playersSearch.filtersNoteEnd'),
    resultsSummary: t('playersSearch.resultsSummary'),
    pageSummary: t('playersSearch.pageSummary'),
    noResults: t('playersSearch.noResults'),
    noResultsDesc: t('playersSearch.noResultsDesc'),
    defaultPlayer: t('playersSearch.defaultPlayer'),
    unknownPlayer: t('playersSearch.unknownPlayer'),
    defaultUser: t('playersSearch.defaultUser'),
    viewProfile: t('playersSearch.viewProfile'),
    message: t('playersSearch.message'),
    orgLabels: {
      independent: t('playersSearch.orgLabels.independent'),
      trainer: t('playersSearch.orgLabels.trainer'),
      club: t('playersSearch.orgLabels.club'),
      agent: t('playersSearch.orgLabels.agent'),
      academy: t('playersSearch.orgLabels.academy'),
      unknown: t('playersSearch.orgLabels.unknown'),
    },
  }), [t]);
