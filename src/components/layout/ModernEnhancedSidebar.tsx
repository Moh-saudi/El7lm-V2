  ...
  const getMenuItems = () => {
    ...
    const accountSpecificItems = {
      ...
      admin: [
        ...
        { id: 'skipcash', label: 'إدارة SkipCash', icon: CreditCard, href: `/dashboard/admin/skipcash`, color: 'text-pink-600', bgColor: 'bg-pink-50' },
        { id: 'pricing', label: 'الأسعار وبوابات الدفع', icon: DollarSign, href: `/dashboard/admin/pricing-management`, color: 'text-emerald-600', bgColor: 'bg-emerald-50' },
