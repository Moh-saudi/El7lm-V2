...
const translations = {
  ar: {
    ...
    features: {
      ...
      asianMarketing: {
        title: 'الانتشار الآسيوي',
        description: 'أول شركة متخصصة في فتح آفاق الاحتراف في الدول الآسيوية والخليج'
      },
      globalConnections: {
        title: 'شبكة عالمية',
    ...
    // Footer
    footer: {
      description: 'منصة الحلم المنصة الأولى لاكتشاف وتطوير المواهب الرياضية في الشرق الأوسط - متخصصين في حوكمة الأندية الرياضية',
      services: 'الخدمات',
      company: 'الشركة',
      support: 'الدعم',
  ...
  en: {
    ...
    features: {
      ...
      asianMarketing: {
        title: 'Asian Reach',
        description: 'First company specialized in connecting talent to all Asian countries and the Gulf'
      },
      globalConnections: {
  ...
  fr: {
    ...
    features: {
      ...
      asianMarketing: {
        title: 'Portée Asiatique',
        description: 'Première entreprise spécialisée dans la connexion des talents vers tous les pays asiatiques et du Golfe'
      },
      globalConnections: {
  ...
  es: {
    ...
    features: {
      ...
      asianMarketing: {
        title: 'Alcance Asiático',
        description: 'Primera empresa especializada en conectar talentos con todos los países asiáticos y del Golfo'
      },
      globalConnections: {
...
export default function AdvancedLandingPage() {
  ...
  return (
    ...
    >
      ...
      <WavyBackground
        containerClassName="py-12 sm:py-16 md:py-20 px-4 h-auto min-h-[40rem]"
        className="max-w-7xl mx-auto w-full"
        colors={['#3b82f6', '#6366f1', '#8b5cf6', '#ec4899', '#14b8a6']}
        backgroundFill={isDarkMode ? '#0f172a' : '#ffffff'}
        blur={10}
        speed="fast"
        waveWidth={50}
        waveOpacity={0.5}
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-8 flex flex-col items-center">
              <div className="mb-6">
                <LayoutTextFlip
                  text={currentLanguage === 'ar' ? "منصة الحلم" : "El7lm Platform"}
                  words={
                    currentLanguage === 'ar'
                      ? ["بوابتك للاحتراف", "بيتك الآمن", "مستقبلك الرياضي"]
                      : ["Your Gateway to Pro", "Your Safe Home", "Your Sports Future"]
                  }
                  className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl justify-center"
                  textClassName="font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent"
                />
              </div>
              ...
              >
                <p className={`text-base sm:text-lg md:text-xl font-medium leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  {currentLanguage === 'ar'
                    ? "المنصة الأولى في الشرق الأوسط لاكتشاف وتطوير المواهب الرياضية. نلتزم بحماية حقوق القاصرين وتوفير بيئة احترافية آمنة تربطهم بأفضل الفرص الحقيقية."
                    : "The leading platform in the Middle East for discovering and nurturing sports talent. We are committed to protecting minors' rights and providing a safe professional environment connecting them with real opportunities."
                  }
                </p>
              </motion.div>
            </motion.div>
            ...
            >
              {[
                ...
                <div
                  key={index}
                  className={`flex items-center space-x-2 space-x-reverse ${badge.color} text-white px-5 py-2.5 rounded-full shadow-md text-sm font-medium hover:opacity-90 transition-opacity`}
                >
                  {badge.icon}
            ...
            {/* Features Grid - Removed to reduce distraction as requested */}

            {/* Auth Buttons in Hero */}
            <motion.div
              variants={itemVariants}
              className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4 sm:px-0 max-w-lg mx-auto"
            >
              <button
                onClick={() => window.location.href = '/auth/login'}
                className={`
                  w-full sm:w-auto px-8 py-3.5 rounded-full font-bold text-lg transition-all duration-300
                  ${isDarkMode
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className={`text-xl ${isDarkMode ? 'text-gray-300' : 'text-gray-600'
              ...
              منصة الحلم هي البيئة الآمنة والاحترافية لاكتشاف وتطوير المواهب الرياضية في الشرق الأوسط. نلتزم بأعلى معايير الحوكمة والشفافية لحماية مستقبل اللاعبين.
            </p>
          </motion.div>
                ...
                {[
                  {
                    ...
                    content: 'شركة ميسك القطرية هي الرائدة في مجال اكتشاف وتطوير المواهب. نعمل على بناء مستقبل رياضي مستدام من خلال حلول تقنية متقدمة تخدم اللاعبين والأندية وتحافظ على حقوق الجميع.',
