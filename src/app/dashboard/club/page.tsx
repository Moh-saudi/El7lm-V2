    ...
    <div className="text-center py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          {t('dashboard.welcome.club.title')}
        </h1>
        <p className="text-xl text-gray-600 mb-8">
          {t('dashboard.welcome.club.subtitle')}
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span className="text-gray-700">{t('dashboard.welcome.club.feat1')}</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span className="text-gray-700">{t('dashboard.welcome.club.feat2')}</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span className="text-gray-700">{t('dashboard.welcome.club.feat3')}</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span className="text-gray-700">{t('dashboard.welcome.club.feat4')}</span>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-6 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">{t('dashboard.welcome.club.tourDesc')}</p>
              </div>
            </div>
            <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="flex items-center gap-3 p-3 bg-white/50 rounded-lg">
              ...
              <div>
                <p className="font-semibold text-gray-900">{t('dashboard.welcome.club.selectPlayers')}</p>
                <p className="text-sm text-gray-600">{t('dashboard.welcome.club.selectPlayersDesc')}</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-white/50 rounded-lg">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white p-8 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">{t('dashboard.welcome.club.ctaTitle')}</h2>
          <p className="text-lg mb-6">
            {t('dashboard.welcome.club.ctaDesc')}
          </p>
