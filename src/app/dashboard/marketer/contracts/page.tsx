    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6" dir="rtl">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-600">إدارة عقود اللاعبين التي تشرف عليها</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Button
                    onClick={() => router.push('/dashboard/marketer/contracts/new')}
            ...
            {filteredContracts.length === 0 ? (
                <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">لا توجد عقود</h3>
                    <p className="text-gray-600">لم يتم العثور على عقود مسجلة.</p>
                </div>
            ) : (
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        <div className="pt-4 flex justify-end gap-2">
                                            <Button variant="outline" size="sm" onClick={() => router.push(`/dashboard/marketer/contracts/${contract.id}`)}>
                                                <Eye className="w-4 h-4 ml-1" />
                                                عرض
                                            </Button>
                                            <Button variant="outline" size="sm" onClick={() => router.push(`/dashboard/marketer/contracts/${contract.id}/edit`)}>
