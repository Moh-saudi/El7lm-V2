...
const TR = {
  ar: {
    ...
    motivation: [
      { a: 'احجز مقعدك في البطولات الدولية،', b: 'واثبت مهارتك أمام العالم.' },
    ...
    forWhomSub:'تم بناء المنظومة لتخدم فئات متعددة داخل القطاع الرياضي، مع وضوح في الرسالة وملاءمة في الاستخدام لكل طرف.',
    forWhom:[
      ...
      {num:'02',title:'للأكاديميات',desc:'إدارة أكثر تنظيمًا للمواهب والخدمات والحجوزات ضمن تجربة رقمية أوضح وأكثر كفاءة.',btn:'اطلب نسخة للأكاديميات',href:'/auth/register?role=academy',color:'#bdc4ef'},
      ...
      {num:'04',title:'للشركاء والجهات الرياضية',desc:'واجهة مؤسسية حديثة تدعم الشراكات والعروض والفرص التجارية ضمن بيئة أكثر وضوحًا وتنظيمًا.',btn:'ناقش الشراكة',href:'/contact',color:'#10b981'},
    ],
    stats: [
          ...
          <div className="ct" style={{position:'relative',zIndex:10}}>
            ...
            <div style={{textAlign:'center',marginBottom:'4rem'}}>
              <span style={{display:'inline-flex',alignItems:'center',gap:'.5rem',background:'rgba(132,217,147,.1)',color:'#84d993',padding:'.4rem 1.25rem',borderRadius:'9999px',fontSize:'.8rem',fontWeight:700,textTransform:'uppercase',letterSpacing:'.12em',marginBottom:'1.5rem'}}>
                ...
                {isRTL ? 'لمن صُممت المنصة؟' : 'Who Is It For?'}
              </span>
                  ...
                  <div style={{ textAlign: isRTL ? 'right' : 'left' }}>
                   <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem', justifyContent: isRTL ? 'flex-start' : 'flex-start' }}>
                      ...
                      <span className="hl" style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.15em', color: theme.primary, textTransform: 'uppercase' }}>
                         {isRTL ? 'كلمة المؤسس' : "FOUNDER'S STATEMENT"}
                      </span>
                   </div>
                   ...
                   <p className="founder-quote" style={{ 
                     ...
                     {isRTL 
                       ? 'بدأنا "الحلم" لأننا نؤمن أن في كل شارع وكل أكاديمية موهبة مدفونة تنتظر من يراها. هدفنا هو أن نوفر لهذه المواهب "العين الرقمية" التي لا تنام، والفرصة التي تستحقها للوصول للعالمية.'
                    ...
                    <div style={{padding:'1.5rem'}}>
                      ...
                      <div style={{display:'flex', width:'100%', marginTop:'1rem'}}>
                        <button style={{width:'100%', padding:'0.75rem', backgroundColor: theme.panelBg, color: theme.primary, borderRadius:'12px', fontSize:'0.875rem', fontWeight:'bold', display:'flex', alignItems:'center', justifyContent:'center', gap:'0.5rem', border:`1px solid ${theme.border}`, cursor:'pointer'}}
                          ...
                          <Eye size={16} /> عرض وتفاصيل التقديم
                        </button>
                      </div>
                    </div>
                  </div>
              ...
              <div style={{background: theme.cardBg,padding:'3rem',borderRadius:'16px',border:'1px solid rgba(70,70,78,.2)',order:isRTL?2:1}}>
                <form 
                  onSubmit={(e) => {
                    ...
                    const subject = formData.get('subject') || (isRTL ? 'استفسار من المنصة' : 'Platform Inquiry');
                    const message = formData.get('message') || '';
                    
                    const bodyText = `${isRTL ? 'الاسم' : 'Name'}: ${name}\n${isRTL ? 'البريد' : 'Email'}: ${email}\n\n${isRTL ? 'الرسالة' : 'Message'}:\n${message}`;
                    ...
                    try {
                      ...
                      alert(isRTL ? "جاري فتح تطبيق البريد الخاص بك (Gmail/Outlook). إذا لم يفتح، يرجى التأكد من إعداد تطبيق بريد افتراضي على جهازك." : "Opening your default email client. If nothing happens, please ensure you have a default mail app configured.");
            ...
            <div style={{padding:'2.5rem', display:'flex', flexDirection:'column', justifyContent:'center'}}>
              ...
              <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'2rem', marginBottom:'2.5rem'}}>
                {[
                  ...
                  {label: isRTL?'المناورة':'Dribbling', value: selectedPlayer.dribbling || 88}
                ].map((s,i)=>(
                  <div key={i}>
        ...
        <div className="pointer-events-auto">
          <FloatingDock
            items={[
              ...
              { title: langAr ? 'كيف يعمل' : 'Process', icon: <Info className="h-full w-full" />, href: '#how-to-use' },
